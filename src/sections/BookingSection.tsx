...
const infoItems = [
  { icon: '📍', label: 'Dirección', value: 'Ave. Bolivar Esq. Leopoldo Navarro No.357' },
  { icon: '📞', label: 'Teléfono', value: '809-687-7707' },
  { icon: '⏰', label: 'Horario', value: 'Lun - Vie: 9:00 AM - 6:00 PM | Sáb: 9:00 AM - 1:00 PM' },
  { icon: '💬', label: 'WhatsApp', value: 'WhatsApp Directo' },
  { icon: '✉️', label: 'Instagram', value: '@dentcodr' },
];
...
export default function BookingSection() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    window.open('https://wa.me/18096877707', '_blank');
    setSent(true);
